...
import no.hvl.dat153.forecastfetcher.auth.Authentication;
import no.hvl.dat153.forecastfetcher.auth.ApiKeyAuth;
import no.hvl.dat153.forecastfetcher.auth.HttpBasicAuth;
import no.hvl.dat153.forecastfetcher.request.GetRequest;
import no.hvl.dat153.forecastfetcher.request.PostRequest;
import no.hvl.dat153.forecastfetcher.request.PutRequest;
import no.hvl.dat153.forecastfetcher.request.DeleteRequest;
import no.hvl.dat153.forecastfetcher.request.PatchRequest;
...
public class ApiInvoker {
  ...
  */
  ...
  public static Object deserialize(String json, String containerType, Class cls) throws ApiException {
    try{
      if("list".equalsIgnoreCase(containerType) || "array".equalsIgnoreCase(containerType)) {
        return ForecastUtils.deserializeToList(json, cls);
      }
        ...
        return ForecastUtils.deserializeToObject(json, cls);
      }
    }
  ...
  public static String serialize(Object obj) throws ApiException {
    try {
      if (obj != null)
        return ForecastUtils.serialize(obj);
      else
        return null;
    }
    catch (Exception e) {
